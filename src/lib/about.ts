...
/**
 * Skills grouped by the three categories the site is built around. Kept short
 * and concrete on purpose: every entry is something with evidence behind it,
 * not a word that sounds like a skill.
 */
export const skillsByCategory: { key: 'dance' | 'design' | 'data'; items: string[] }[] = [
  {
    key: 'dance',
    items: ['Ballet', 'Graham / Horton modern', 'Contemporary', 'Arena crowd work', 'Event activations'],
  },
  {
    key: 'design',
    items: [
      ...
      'Illustrator',
      'Investor decks',
      'Clinical and technical figures',
      'Short-form video',
    ],
  },
  {
...
export const supporting =
  'React, TypeScript, Next.js, Tailwind, Git, Vercel — enough to build and ship this site myself.';
