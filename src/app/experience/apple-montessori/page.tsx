...
const role = experiences.find((r) => r.slug === 'apple-montessori')!;

export const metadata: Metadata = {
  title: 'Apple Montessori Schools',
  description: 'Business Intelligence + Data Analytics Intern at Apple Montessori Schools, October 2023 to May 2026. KPI dashboards, predictive enrollment models, and pricing analysis across 20+ schools.',
  alternates: { canonical: '/experience/apple-montessori' },
};

export default function AppleMontessoriPage() {
  return (
    <DriveDoc backHref="/experience" backLabel="Experience" fileName={role.company}>
      ...
      <div className="flex flex-wrap gap-2">
        {role.skills.map((skill) => (
          <span key={skill} className="rounded-lg border px-3 py-1 text-[13px]" style={{ borderColor: 'var(--gd-chip-border)', borderWidth: '0.5px', color: 'var(--gd-text-2)' }}>
            {skill}
          </span>
        ))}
      </div>
