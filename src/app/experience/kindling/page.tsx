...
const role = experiences.find((r) => r.slug === 'kindling')!;

export const metadata: Metadata = {
  title: 'Kindling Education Partners',
  description:
    'Contract web design and development for Kindling Education Partners, May 2026 to present. Corporate landing page built for acquisition targets, investors, and talent.',
  alternates: { canonical: '/experience/kindling' },
};
