...
const role = experiences.find((r) => r.slug === 'medara')!;

export const metadata: Metadata = {
  title: 'Medara',
  description: 'Product Designer at Medara, March 2026 to present. Investor-facing materials and clinical figures for a pre-FDA AI medical-imaging startup.',
  alternates: { canonical: '/experience/medara' },
};

export default function MedaraPage() {
  return (
