    ...
    >
      ...
      <header className="flex items-center gap-3 px-4 py-2.5">
        <Link
          ...
          className="flex h-9 w-9 items-center justify-center rounded-full transition-colors hover:bg-[var(--gd-pill)]"
        >
          <IconArrowLeft size={20} color="var(--gd-text-2)" stroke={1.75} aria-hidden="true" />
        </Link>
        <span className="truncate text-[15px] font-medium" style={{ color: 'var(--gd-text)' }}>
          {fileName}
        </span>
        <Link
          href="/about"
      ...
      <main id="main-content" className="flex-1 px-4 pb-10">
        <article
          className="mx-auto max-w-3xl rounded-2xl border bg-[var(--gd-surface)] px-6 py-8 sm:px-10 sm:py-10"
