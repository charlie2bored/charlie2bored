...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Navigation Toggle - Only show when desktop nav is hidden */}
      <div className="sm:hidden fixed top-4 left-4 z-50">
        <button
          onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
          className="w-12 h-12 bg-[var(--off-white)] rounded-full shadow-lg flex items-center justify-center text-[var(--brand-dark)] hover:bg-[var(--brand-light)] transition-colors duration-200"
            ...
            <div className="p-6">
              <div className="flex justify-between items-center mb-8">
                ...
                <button
                  ...
                  className="w-12 h-12 flex items-center justify-center text-[var(--brand-dark)] hover:bg-[var(--brand-light)] rounded-full transition-colors duration-200"
